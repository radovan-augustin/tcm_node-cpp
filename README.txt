...
tcm_node-cpp is part of tcm_node.py rewritten to C++,
it supports iblock backend and iSCSI over IP frontend
and can run with uClibc++ on embedded devices with OpenWrt.
